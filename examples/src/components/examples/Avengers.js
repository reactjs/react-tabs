...
const code = `class Component extends React.Component {
  constructor(props) {
    ...
    this.characters = [
      ...
      { name: "Iron Man",  img: "${ironman}", color: "LightCoral", text: "black", desc: "\\"My armor was never a distraction or a hobby. It was a part of me. And now I'm a changed man. You can take away my house, all my tricks and toys. But there is one thing that you can't take away from me... I am Iron Man.\\"" },
